...
import {Breadcrumb,BreadcrumbItem,Form,FormGroup,Input,Label,Col,Button,FeedbackForm, FormFeedback}from'reactstrap';
                    ...
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={{size:3 ,offset:1}}>
                                <Input type='select' name='contactType' value={this.state.cotnactType}
                                onChange={this.handleInputChange}>
                                    <option>Tel.</option>
                                    <option>Email</option>
                                 </Input>
