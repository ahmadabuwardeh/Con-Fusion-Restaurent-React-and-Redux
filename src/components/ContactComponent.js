...
const emailValid=(val)=>/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i.test(val);
                    ...
                    <LocalForm onSubmit={(values)=>this.handleSubmit(values)}>
                        <Row className='form-group'>
                            ...
                            <Col md={10}>
                                ...
                                <Errors 
                                    className='text-danger' show='touched' model='.firstname'
                                    messages={{
                                        required:'Required',
                        ...
                        <Row className='form-group'>
                            ...
                            <Col md={10}>
                                ...
                                validators={{required,maxLength:maxLength(15),minLength:minLength(3)}}/>
                                <Errors 
                                    className='text-danger' show='touched' model='.lastname'
                                    messages={{
                                        required:'Required',
                        ...
                        <Row className='form-group'>
                            ...
                            <Col md={10}>
                                ...
                                <Errors 
                                    className='text-danger' show='touched' model='.telnum'
                                    messages={{
                                        required:'Required',
                                        minLength:'Must be more than 3 numbers',
                        ...
                        <Row row>
                            ...
                            <Col md={10}>
                                ...
                                <Errors 
                                    className='text-danger' show='touched' model='.email'
                                    messages={{
                                        required:'Required',
